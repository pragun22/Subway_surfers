...
function initBuffers(gl) {
  ...
  for(var j = 0 ; j < 4 ; ++j){
    ...
    [0.6,  0.6,  0.7,  1.0],    // Left face: purple
    [0.3,  0.7,  0.2,  0.8],    // Left face: purple
    [1.0,  0.3,  0.9,  0.9],    // Left face: purple
    [0.4,  0.0,  0.4,  1.0],    // Left face: purple
    [0.2,  0.3,  1.0,  1.0],    // Left face: purple     
    );
  }
  // const faceColors = [
  //   [1.0,  0.0,  0.4,  1.0],    // Left face: purple
